...
e({version:"preview1",args:f.slice(1),env:h,preopens:{".":".","/tmp":"/tmp"},returnOnExit:!1}),c=d.getImportObject();function
k(a){const
b=require("node:path"),c=b.join(b.dirname(module.filename),a);return require("node:fs/promises").readFile(c)}async function
...
m=await
i();d.start(m.instance)})(function(a){"use strict";return{}}(globalThis))({"link":[["code",0]],"generated":{},"src":"unhandled_unlinked.native.assets"});
